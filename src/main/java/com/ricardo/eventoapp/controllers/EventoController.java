package com.ricardo.eventoapp.controllers;
...
import com.ricardo.eventoapp.repository.ConvidadoRepository;
import com.ricardo.eventoapp.repository.EventoRepository;
...
public class EventoController {
	...
	public String form(@Valid Evento evento, BindingResult result, RedirectAttributes atributes ) {
		if(result.hasErrors()) {
			atributes.addFlashAttribute("mensagem", "Verifique os campos em branco!");
